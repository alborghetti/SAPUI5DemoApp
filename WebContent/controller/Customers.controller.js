sap.ui.define([
	...
	return BaseController.extend("it.interlem.sapui5TrainingTrainingDemo.controller.Customers", {
		formatter: formatter,
		...
		/**
		 * Called when the Customer controller is instantiated. 
		...
		ordersCount: function(oValue) {
		    //read the number of orders returned
		    if (oValue) {
		...
		_onMasterMatched :  function() {
			this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
				function (mParams) {
					...
					var sObjectId = mParams.firstListitem.getBindingContext().getProperty("CustomerID");
