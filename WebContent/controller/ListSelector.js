sap.ui.define([
		...
		return BaseObject.extend("it.interlem.sapui5TrainingTrainingDemo.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias it.interlem.model.ListSelector
			 */
			 ...
			 * @return {it.interlem.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
